...
function processar(){
	...
	else if ($('#addr3').hasClass('hidden-xs-up')){
...
function startAnimation(){
	// setTimeout(function(){ mostrar(); console.log("mostrar"); }, 1);
	setTimeout(function(){ processar(); console.log("processar"); }, 1);
	// setTimeout(function(){ esconder(); console.log("esconder"); }, 1);
	}
...
$('#delete_row').click(function(){
	...
	else if (!$('#addr1').hasClass('hidden-xs-up')){
