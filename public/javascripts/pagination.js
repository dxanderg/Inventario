...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            // <input type="text" class="form-control" placeholder="Ingrese el registro a buscar" aria-describedby="sizing-addon1">
            g = '<div class="input-group "><span class="input-group-addon" id="sizing-addon1">Buscar</span><input type="search" class="' + b.sFilterInput + '" /><span id="btn_limpiar" class="input-group-addon" id="sizing-addon1">Limpiar</span></div>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "No hay datos habiles en la tabla",
...
(function(b) {
    ...
    b.extend(!0, f.defaults, {
        dom: "<'row'<'col-sm-3'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-3'i><'col-sm-9'p>>",
        renderer: "bootstrap"
    });
    ...
    f.ext.renderer.pageButton.bootstrap = function(a, h, r, s, j, n) {
        ...
        q(b(h).empty().html('<ul class="pagination pagination-lg"/>').children("ul"), s);
